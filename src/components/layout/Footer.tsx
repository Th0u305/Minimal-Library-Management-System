        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-12">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-6">
                Your ultimate destination for discovering amazing books and connecting with fellow readers worldwide.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {["About Us", "Our Authors", "Blog", "Contact", "Privacy Policy", "Terms of Service"].map((link) => (
                  <li key={link}>
            ...
            <div>
              <h4 className="font-bold text-lg mb-6 text-white">Featured Books</h4>
              <div className="space-y-4">
                {[
                  { title: "The Midnight Library", author: "Matt Haig", price: "$12.99" },
                  ...
                  <div key={index} className="flex items-center space-x-3 group cursor-pointer">
                    ...
                    <div>
                      ...
                      <p className="text-purple-400 font-bold text-sm">{book.price}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center">
            <p className="text-gray-400">
              &copy; 2024 Book Lovers. All rights reserved. Made with ❤️ for book enthusiasts worldwide.
            </p>
          </div>
        </div>
      </footer>
