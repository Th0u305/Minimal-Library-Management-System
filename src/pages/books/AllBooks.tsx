        ...
        {books?.data.length === 0 ? (
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {books?.data.map((book: IBook, idx: number) => (
              <Card
                key={idx}
                className="group hover:shadow-medium transition-all duration-300 border-border/50 p-5 h-full justify-evenly"
              >
                <CardHeader className="p-0">
                  <div className="flex justify-between items-start">
                    ...
                    <Badge
                      ...
                      className={
                        book.available ? "ml-2 bg-green-600" : "ml-2 bg-red-600"
                      }
                    >
